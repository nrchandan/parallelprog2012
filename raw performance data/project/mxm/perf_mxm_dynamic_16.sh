...
perf stat -r 5 -o perf_mxm_dynamic_16.tmp ./mxm > perf_mxm_dynamic_16.out
cat perf_mxm_dynamic_16.tmp > perf_mxm_dynamic_16.txt
#
echo "Run with 16 threads."
export OMP_NUM_THREADS=16
...
cat perf_mxm_dynamic_16.tmp >> perf_mxm_dynamic_16.txt
#
rm -f perf_mxm_dynamic_16.tmp
#
#. Discard the executable file.
#
rm mxm
#
#echo "Program output written to perf_mxm_dynamic_16.out"
