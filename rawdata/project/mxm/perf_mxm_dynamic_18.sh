...
perf stat -r 5 -o perf_mxm_dynamic_18.tmp ./mxm > perf_mxm_dynamic_18.out
cat perf_mxm_dynamic_18.tmp > perf_mxm_dynamic_18.txt
#
echo "Run with 18 threads."
export OMP_NUM_THREADS=18
...
cat perf_mxm_dynamic_18.tmp >> perf_mxm_dynamic_18.txt
#
rm -f perf_mxm_dynamic_18.tmp
#
#. Discard the executable file.
#
rm mxm
#
#echo "Program output written to perf_mxm_dynamic_18.out"
