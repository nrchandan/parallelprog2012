...
perf stat -r 5 -o perf_mxm_static_14.tmp ./mxm > perf_mxm_static_14.out
cat perf_mxm_static_14.tmp > perf_mxm_static_14.txt
#
echo "Run with 14 threads."
export OMP_NUM_THREADS=14
...
cat perf_mxm_static_14.tmp >> perf_mxm_static_14.txt
#
rm -f perf_mxm_static_14.tmp
#
#. Discard the executable file.
#
rm mxm
#
#echo "Program output written to perf_mxm_static_14.out"
#./bin/bash
#
#. Compile the program with GCC.
#
...
export OMP_SCHEDULE='static'
perf stat -r 5 -o perf_mxm_static_16.tmp ./mxm > perf_mxm_static_16.out
cat perf_mxm_static_16.tmp > perf_mxm_static_16.txt
#
echo "Run with 16 threads."
export OMP_NUM_THREADS=16
export OMP_SCHEDULE='static,2'
...
cat perf_mxm_static_16.tmp >> perf_mxm_static_16.txt
#
rm -f perf_mxm_static_16.tmp
#
#. Discard the executable file.
#
rm mxm
#
#echo "Program output written to perf_mxm_static_16.out"
#./bin/bash
#
#. Compile the program with GCC.
#
