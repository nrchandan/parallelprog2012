...
perf stat -r 5 -o perf_mxm_dynamic_14.tmp ./mxm > perf_mxm_dynamic_14.out
cat perf_mxm_dynamic_14.tmp > perf_mxm_dynamic_14.txt
#
echo "Run with 14 threads."
export OMP_NUM_THREADS=14
...
cat perf_mxm_dynamic_14.tmp >> perf_mxm_dynamic_14.txt
#
rm -f perf_mxm_dynamic_14.tmp
#
#. Discard the executable file.
#
rm mxm
#
#echo "Program output written to perf_mxm_dynamic_14.out"
